...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.accountMonth.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.account-months.update", [$accountMonth->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
